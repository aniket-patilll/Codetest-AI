    ...
    return (
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-4 group">
                <img src="/thirdeye-logo.webp" alt="ThirdEye Data" className="h-8 w-auto object-contain" />
                <div className="h-7 mt-2 w-px bg-border"></div>
                <span className="text-xl font-bold tracking-tight mt-2 text-foreground/90">CodeTest-AI</span>
            </Link>

            <div className="hidden md:flex items-center gap-4">
            <Link to="/login" className="text-sm font-medium text-primary hover:text-black transition-colors">
                Sign In
            </Link>
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="container mx-auto px-4 lg:py-24 py-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-grey-800 mb-8 max-w-xl leading-relaxed">
        ...
        <section className="container mx-auto px-4 py-2">
            <div className="rounded-3xl bg-white border border-white/10 p-8 md:p-16 text-center relative overflow-hidden">
