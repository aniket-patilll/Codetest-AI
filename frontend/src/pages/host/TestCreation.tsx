...
const TestCreation: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-3 md:p-1 space-y-8 animate-in fade-in duration-500">
      
      {/* Premium Header */}
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-8 border-b border-border relative">
        <div className="space-y-4 relative z-10">
          ...
          <div>
            ...
            <p className="text-black mt-2 text-bold max-w-xl text-lg font-light leading-relaxed">
        ...
        {isEditMode && (
          <div className="flex gap-4">
             <Button 
               variant="outline"
               className="border-input bg-white/5 hover:bg-white/10 text-white backdrop-blur-sm transition-all"
      ...
      <Tabs defaultValue="settings" value={activeTab} onValueChange={setActiveTab} className="space-y-8">
        <div className="flex items-center justify-center">
           <TabsList className="bg-white border border-input p-1.5 h-auto rounded-full backdrop-blur-md">
             {[
          ...
          <div className="glass-panel p-8 rounded-2xl space-y-8 shadow-2xl shadow-black/50">
             <div className="space-y-6">
                <div className="space-y-3">
                   <Label className="text-foreground text-sm uppercase tracking-wider font-semibold">Assessment Title</Label>
                   <div className="relative group">
                     ...
                     <Input
                       ...
                       className="pl-12 bg-white border-input text-black placeholder:text-zinc-600 focus-visible:ring-emerald-500/50  h-14 text-lg rounded-xl transition-all"
                     />
                   </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                   <div className="space-y-3">
                      <Label className="text-foreground text-sm uppercase tracking-wider font-semibold">Duration (Minutes)</Label>
                      <div className="relative group">
                        ...
                        <Input
                          ...
                          className="pl-12 bg-white border-input text-black focus-visible:ring-emerald-500/50 h-14 text-lg rounded-xl"
                        />
                      </div>
                   </div>
                   <div className="space-y-3">
                      <Label className="text-foreground text-sm uppercase tracking-wider font-semibold">Access Control</Label>
                      <div className="relative group">
                         ...
                         <Input
                           ...
                           className="pl-12 pr-12 bg-white border-input text-black focus-visible:ring-emerald-500/50 h-14 text-lg rounded-xl"
                         />
                         <button
                           type="button"
        ...
        <TabsContent value="questions" className="space-y-8 max-w-5xl mx-auto animate-in slide-in-from-bottom-4 duration-500 fade-in">
          <div className="flex flex-col sm:flex-row justify-between items-end gap-4 b-white p-6 rounded-2xl border border-border shadow-xl">
             <div>
                <h3 className="text-xl font-bold text-black mb-2">Coding Challenges</h3>
                <p className="text-zinc-900">Curate a set of problems to test candidate skills.</p>
             </div>
             <div className="flex gap-3">
                ...
                <Button onClick={addQuestion} className="bg-primary text-white hover:bg-zinc-200 transition-colors font-semibold">
          ...
          <div className="space-y-6">
             {questions.length === 0 ? (
               <div className="flex flex-col items-center justify-center py-24 px-4 text-center border border-dashed border-input rounded-3xl bg-white/5 backdrop-blur-sm">
                 <div className="bg-white p-5 rounded-full mb-6 ring-1 ring-white/10">
                 ...
                 <div className="flex gap-4">
                    ...
                    <Button variant="outline" className="border-input bg-black/20 hover:bg-white text-foreground" onClick={addQuestion}>
                      <Plus className="mr-2 h-4 w-4" />
                      Manual Entry
                    </Button>
                 </div>
               ...
               questions.map((question, qIndex) => (
                 <div key={question.id} className="group rounded-2xl border border-border bg-card overflow-hidden transition-all hover:border-input hover:shadow-2xl hover:shadow-black/50">
                    <div className="p-5 border-b border-border flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white/[0.02]">
                       <div className="flex items-center gap-4 w-full">
                          ...
                          <Input 
                             ...
                             className="h-10 bg-transparent border-transparent text-xl font-bold text-foreground placeholder:text-zinc-600 focus-visible:ring-0 focus-visible:border-input px-0 w-full hover:bg-white/5 transition-colors rounded-lg px-2"
                          />
                       </div>
                       <Button
                          variant="ghost"
                    ...
                    <div className="p-6 md:p-8 space-y-8">
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-3">
                             ...
                             <div className="relative">
                               <select
                                  className="w-full h-12 rounded-xl border border-input bg-white px-4 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-emerald-500/50 appearance-none hover:bg-zinc-100 transition-colors"
                          ...
                          <div className="space-y-3">
                             ...
                             <Input 
                                ...
                                className="h-12 bg-white border-input text-foreground rounded-xl focus-visible:ring-emerald-500/50 hover:bg-zinc-100 transition-colors"
                             />
                          </div>
                       </div>
                       ...
                       <div className="space-y-3">
                          ...
                          <Textarea
                             className="min-h-[160px] bg-white border-input text-foreground resize-y font-mono text-sm leading-relaxed rounded-xl focus-visible:ring-emerald-500/50 p-4 hover:bg-zinc-100 transition-colors"
                       ...
                       <div className="space-y-4 pt-6 border-t border-border">
                          ...
                          <div className="grid gap-4">
                             {question.testcases.map((tc, tcIndex) => (
                                <div key={tc.id} className="grid grid-cols-1 md:grid-cols-[1fr_1fr_auto] gap-4 items-start bg-muted/30 p-4 rounded-xl border border-border hover:border-input transition-colors">
                                   <div className="space-y-1.5">
                                      ...
                                      <Input
                                         ...
                                         className="font-mono text-xs bg-white border-input text-foreground h-10 rounded-lg focus-visible:ring-emerald-500/30"
                                      />
                                   </div>
                                    <div className="space-y-1.5">
          ...
          <div className="flex justify-end gap-3 sticky bottom-6 z-10 pt-4 pointer-events-none">
             <div className="bg-white border border-input p-2.5 rounded-2xl flex gap-3 backdrop-blur-xl shadow-2xl pointer-events-auto">
               <Button variant="ghost" className="text-zinc-400 hover:text-black hover:bg-white/5 rounded-xl px-4" onClick={() => handleSave('draft')} disabled={isSaving}>
                 {isSaving ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Save className="mr-2 h-4 w-4" />}
                 Save Draft
               </Button>
               <Button className="bg-primary hover:bg-primary/80 text-white shadow-lg shadow-primary/20 rounded-xl px-6 font-semibold tracking-wide" onClick={() => handleSave('active')} disabled={isSaving}>
        ...
        {isEditMode && (
          <TabsContent value="participants" className="space-y-8 max-w-5xl mx-auto animate-in slide-in-from-bottom-4 duration-500 fade-in">
             <div className="bg-white p-6 rounded-2xl border border-indigo-500/20 shadow-lg">
                <h3 className="text-xl font-bold text-black mb-1">Active Candidates</h3>
                <p className="text-zinc-900">Monitor progress and status of invited students.</p>
             </div>
             
             {participants.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-24 border border-dashed border-input rounded-3xl bg-white/5">
                   <Users className="h-12 w-12 mb-4 opacity-20 text-white" />
                   <p className="font-semibold text-foreground text-lg">No candidates registered</p>
                   <p className="text-zinc-500">Share your test link to get started.</p>
                </div>
             ) : (
                <div className="grid gap-4">
                   {participants.map((p) => (
                      <div key={p.id} className="flex items-center justify-between p-5 rounded-2xl border border-border bg-card hover:bg-white/5 transition-colors group">
                         <div className="flex items-center gap-5">
                            ...
                            <div>
                               <div className="font-bold text-black text-lg group-hover:text-indigo-400 transition-colors">{(Array.isArray(p.user) ? p.user[0] : p.user)?.full_name || 'Unknown User'}</div>
                         ...
                         <div className="flex flex-col items-end gap-2">
                            <Badge variant="secondary" className={cn(
                               ...
                               p.status === 'submitted' ? 'bg-primary-500/10 text-primary-400 ring-1 ring-primary-500/20' :
      ...
      <Dialog open={showAIDialog} onOpenChange={setShowAIDialog}>
        <DialogContent className="sm:max-w-lg bg-card border-border text-foreground shadow-2xl shadow-indigo-900/20">
          ...
          <div className="space-y-6 py-6">
            <div className="space-y-3">
              <Label className="text-foreground font-semibold">What kind of problem?</Label>
              <Textarea 
                placeholder="e.g. Design a system to track real-time stock prices..." 
                className="min-h-[120px] bg-white border-input text-foreground resize-none focus-visible:ring-indigo-500/50 rounded-xl p-4 text-base"
                value={aiPrompt}
            ...
            <div className="grid grid-cols-2 gap-6">
               <div className="space-y-3">
                 ...
                 <div className="relative">
                    <select
                      className="w-full h-12 rounded-xl border border-input bg-white px-4 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-indigo-500/50 appearance-none"
                      value={aiDifficulty}
               ...
               <div className="space-y-3">
                 <Label className="text-foreground font-semibold">Test Cases</Label>
                 <Input
                   type="number"
                   min={3}
                   max={10}
                   ...
                   className="h-12 bg-white border-input text-foreground focus-visible:ring-indigo-500/50 rounded-xl"
                 />
               </div>
            </div>
          </div>
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent className="sm:max-w-md bg-card border-border text-foreground shadow-2xl shadow-emerald-900/20">
          <DialogHeader className="pb-4 border-b border-border">
          ...
          <div className="space-y-6 py-6">
            <div className="space-y-3">
              <Label className="text-black text-xs uppercase tracking-widest font-bold">
                 Direct Join Link
              </Label>
              <div className="flex gap-2">
                <div className="relative flex-1">
                   ...
                   <Input
                     ...
                     className="pl-10 font-mono text-sm bg-white border-border text-foreground h-10 rounded-lg selection:bg-emerald-900/50"
                   />
                </div>
                <Button variant="outline" size="icon" onClick={handleCopyLink} className="border-border bg-primary hover:bg-primary/80 text-white rounded-lg h-10 w-10 shrink-0">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <div className="flex-1 rounded-xl border border-dashed border-zinc-700 bg-muted/30 p-5 text-center relative group">
                  <div className="absolute inset-0 bg-emerald-500/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl" />
                  <span className="font-mono text-4xl font-black tracking-[0.2em] text-black relative z-10 selection:bg-emerald-500/30">
                    {test?.join_code || '--------'}
                  </span>
                </div>
                <Button variant="outline" size="icon" onClick={handleCopyCode} className="h-auto border-border bg-primary hover:bg-primary/80 text-white rounded-xl w-14 shrink-0 transition-all">
            ...
            <div className="flex gap-3 pt-4">
              <Button variant="outline" className="flex-1 h-11 border-border text-foreground hover:text-white hover:bg-zinc-800 rounded-xl" onClick={() => navigate('/host')}>
                Done
              </Button>
              {!isEditMode && (
                <Button className="flex-1 h-11 bg-primary text-white hover:bg-primary/80 rounded-xl font-semibold" onClick={() => {
